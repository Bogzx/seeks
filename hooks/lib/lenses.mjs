...
export const DEFAULT_LENSES = [
  ...
  'security-injection', 'security-authz', 'performance', 'data-integrity', 'api-contract',
  'dependency-supply', 'state-machine', 'numeric-precision', 'time-timezone', 'encoding-locale',
];
